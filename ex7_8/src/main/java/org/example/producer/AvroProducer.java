...
public class AvroProducer {
    ...
    public static void send(String topic){
        ...
        Company my_avroComp = new Company();
        my_avroComp.setRegisteredName("Yt");
        my_avroComp.setTradeNumber(1);

        ProducerRecord<String, Company> data = new ProducerRecord<>(topic, "key"+number, my_avroComp);
        try {
